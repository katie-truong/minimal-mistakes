...
**Note**: To use `plotly` in R, you also need to follow [this guide](https://plot.ly/r/getting-started/) to set up (`plotly` also supports a variety of languages including Python, so feel free to choose the language of your choice).
...
which gives us a dataframe of basic stats, per type:
